...
Passport auth discoverability is split across the package and governed package-surface docs: `packages/passport/README.md` documents `PassportModule.forRoot(...)` strategy registry wiring, `AuthGuard` and optional auth/scope decorators, Passport.js strategy bridges, cookie-auth and refresh-token presets, account-linking helpers, public auth metadata helpers, and platform status/diagnostic helpers such as `createPassportPlatformStatusSnapshot(...)`; [`docs/reference/package-surface.md`](./reference/package-surface.md) carries the canonical `@fluojs/passport` package responsibility summary; and [`docs/contracts/public-export-tsdoc-baseline.md`](./contracts/public-export-tsdoc-baseline.md) keeps public helper documentation aligned with the exported API surface.
