...
| **plan preview** | `fluo new ... --print-plan`은 같은 resolved starter 계약을 사용하는 non-writing preview로 읽습니다. 선택된 named starter와 recipe, package manager, install/git 선택, dependency 세트를 출력하지만 파일 생성, dependency 설치, git 초기화는 수행하지 않습니다. |
