...
| Need localization or i18n services | `@fluojs/i18n` | Use for framework-agnostic internationalization module registration, standalone service creation, shared option/error types, and `@fluojs/i18n/icu` plural/select MessageFormat support. |
