...
| Need the default Node.js adapter | `@fluojs/platform-fastify` | Recommended starter path for most Node.js 20.19.3+ projects; the package declares `engines.node >=20.19.3` so listener-level RFC `QUERY` reaches fluo dispatch. |
