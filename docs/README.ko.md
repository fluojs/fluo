...
| --- | --- | --- |
| 제품·패턴 중심의 전체 학습 경로 | `book/series.json`과 새 3권 본문 | Book이 중심이며, 사이트와 루트 README는 해당 권과 장으로 안내합니다. |
...
- 책은 한국어 전체를 집필·검토한 뒤 영어로 번역합니다. 중간 한국어 검증은 `pnpm book:check:ko`, 최종 양 언어 검증은 `pnpm book:check`를 사용합니다.
