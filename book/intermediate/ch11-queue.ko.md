...
- 패키지 자체의 지원 계약으로 Node.js `>=20.19.3 <21 || >=22.2.0 <27` 애플리케이션 런타임.
...
`@fluojs/queue`는 필수 `engines.node >=20.19.3 <21 || >=22.2.0 <27` 범위를 패키지 자체의 지원 계약으로 선언합니다. 이 major Queue release를 적용하기 전에 Node.js `20.0.0`–`20.19.2`, Node.js 21, Node.js `22.0.0`–`22.1.x`, 또는 Node.js 27+ deployment를 지원되는 release로 이동하세요.
