...
- **Core API Gateway**: Handles edge HTTP ingress on **Cloudflare Workers** and routes GraphQL requests to a Node.js `>=20.19.3 <21 || >=22.2.0 <27` API service. The Worker does not host `@fluojs/graphql` itself.
