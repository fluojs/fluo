...
- **Core API Gateway**: Handles edge HTTP ingress on **Cloudflare Workers** and routes GraphQL requests to a Node.js `>=20.19.3` API service. The Worker does not host `@fluojs/graphql` itself.
