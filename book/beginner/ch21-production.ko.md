...
이 구조와 운영 장치는 앱에 맞게 구현하고 실제 트래픽을 받기 전에 확인할 설계 항목입니다. 입문 실습 결과는 [현재 튜토리얼의 테스트](../../apps/docs/content/docs/tutorial/testing.mdx)에서 확인하며, 그것만으로 프로덕션 적합성을 보장하지 않습니다.
