...
이렇게 하면 인터셉터와 동일한 강력함과 일관성을 유지하면서도, 변환 시점과 방식을 직접 제어할 수 있습니다.
...
가끔 공개 응답에는 가벼운 마무리 변환이 필요합니다. summary 값을 trim하거나, 사용자 이름을 대문자로 보여 주거나, 파생된 표시 값을 포맷해야 할 수 있습니다. 이런 작업은 도메인 로직이라기보다 전송 경계에서의 표현 문제이므로 DTO 근처에 두는 편이 자연스럽습니다.
