...
For the companion Node engine alignment, Node 21 is unsupported, and Node 27 is unsupported. Move
each process to Node >=20.19.3 <21 or Node >=22.2.0 <27 before updating.
