...
Migration: For `@fluojs/platform-express`, `@fluojs/platform-fastify`, and `@fluojs/platform-nodejs`, Node.js >=20.0.0 <20.19.3 support is removed; for `@fluojs/graphql`, Node.js >=20.16.0 <20.19.3 support is removed. Node.js 21, Node.js >=22.0.0 <22.2.0, and Node.js 27 or newer are also no longer supported. Upgrade existing Node listener deployments and regenerated Node HTTP projects to Node.js >=20.19.3 <21 or >=22.2.0 <27.
