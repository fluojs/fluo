...
Declare the package-owned Node.js support range `>=24.0.0 <27` for `@fluojs/discord` in the upcoming coordinated release. The portable `@fluojs/runtime` package no longer supplies a transitive Node engine requirement.
