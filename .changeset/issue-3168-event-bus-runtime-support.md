...
Migration: Node.js 20.0.0-20.19.2, Node.js 21, Node.js 22 before 22.2.0, and Node.js 27 or newer are no longer supported. Upgrade to Node.js `>=20.19.3 <21 || >=22.2.0 <27` before installing this version. Handler, module visibility, and publish failure-isolation APIs otherwise remain unchanged.
