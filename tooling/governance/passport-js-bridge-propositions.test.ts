...
describe('Passport.js bridge unsupported propositions', () => {
  it.each([
    ...
    ['middleware-installation', 'Bridge installs Passport middleware.'],
    ['middleware-installation', 'The Bridge installs Passport middleware.'],
    ...
    ['middleware-installation-ko', 'Bridge는 Passport middleware를 설치합니다.'],
  ...
  it.each([
    ...
    'The bridge supports middleware installed by the application.',
  ...
  it.each([
    ...
    ['middleware-installation', 'The bridge installs Passport middleware, not sessions.'],
    ['middleware-installation', 'The bridge installs Passport middleware without configuring sessions.'],
    ['middleware-installation', 'Passport middleware is installed by the bridge.'],
