...
- [#3792](https://github.com/fluojs/fluo/pull/3792) [`5889734`](https://github.com/fluojs/fluo/commit/588973406ab6bdf14899ae421c74c58231ca4012) Thanks [@ayden94](https://github.com/ayden94)! - Remove `createMongooseProviders()` and `MongooseTransactionInterceptor`.
...
- [#3601](https://github.com/fluojs/fluo/pull/3601) [`c5eb4ef`](https://github.com/fluojs/fluo/commit/c5eb4efcf63f633711d2184964f3df80ee2ddbda) Thanks [@ayden94](https://github.com/ayden94)! - Add the opt-in `MongooseConnection.saveDocument(...)` helper for saving existing documents with the active transaction session.

### Patch Changes

- [#3590](https://github.com/fluojs/fluo/pull/3590) [`c33835d`](https://github.com/fluojs/fluo/commit/c33835d2a98b754b2248b9af73af4965822006fa) Thanks [@ayden94](https://github.com/ayden94)! - Preserve transaction shutdown ownership while a manual session is acquired and cleaned up.

- [#3593](https://github.com/fluojs/fluo/pull/3593) [`39a1352`](https://github.com/fluojs/fluo/commit/39a135290df25322801e99da9430da6643574240) Thanks [@ayden94](https://github.com/ayden94)! - Preserve zero-argument aggregate calls while attaching ambient transaction sessions.

- [#3596](https://github.com/fluojs/fluo/pull/3596) [`bb6029d`](https://github.com/fluojs/fluo/commit/bb6029d0586c6251d1ea019f1da249a81c2599b2) Thanks [@ayden94](https://github.com/ayden94)! - Correct Mongoose transaction and NestJS migration guidance, including explicit DI and transaction-target examples.
