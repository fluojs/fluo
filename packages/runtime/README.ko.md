...
- 호환되는 same-realm integration 사본이 작성한 legacy route-inspection marker는 runtime inspection 사본에서도 discovery됩니다. Marker는 immutable projection detail로 유지되며 route matching, conflict detection, dispatch 또는 request-private data ownership을 바꾸지 않습니다.
