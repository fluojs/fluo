...
- [#3704](https://github.com/fluojs/fluo/pull/3704) [`271540e`](https://github.com/fluojs/fluo/commit/271540e9f2c1e5f6b18766291de19e056a3b669a) Thanks [@ayden94](https://github.com/ayden94)! - Clarify the shipped English and Korean README examples: `@Get()` uses an empty
  relative path while preserving controller prefixes, and an empty `@Module()` can
  bootstrap and close without providers.
