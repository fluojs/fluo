...
Canonical 계약은 [Health와 Readiness](../../docs/contracts/health-and-readiness.ko.md)입니다. 이 README는 설치와 필수 package API를 유지하면서 Docs가 소유한 계약을 요약하며, 위 sentinel도 검증되는 요약으로 유지합니다. 시작, close 순서와 자원 소유권은 [Lifecycle & Shutdown](../../docs/architecture/lifecycle-and-shutdown.ko.md)을 따릅니다.
