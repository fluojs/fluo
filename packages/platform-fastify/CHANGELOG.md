...
- [#3830](https://github.com/fluojs/fluo/pull/3830) [`10b121f`](https://github.com/fluojs/fluo/commit/10b121fc044fa1e348dfd95af26798c65597a631) Thanks [@ayden94](https://github.com/ayden94)! - Preserve request, Fastify adapter handoff, abort, and request-id behavior, container, dispatch-context, and Registry-owner-bound state across compatible same-realm package copies without globalizing independent applications, containers, registries, or transaction context.
...
- [#3432](https://github.com/fluojs/fluo/pull/3432) [`4757b4a`](https://github.com/fluojs/fluo/commit/4757b4ab68392a8e6c212f66b0494bfeda60108f) Thanks [@ayden94](https://github.com/ayden94)! - Add `configureFastify` for construction-time Fastify-native plugin, hook, and instance configuration, including cleanup after configuration failures.
...
- [#3610](https://github.com/fluojs/fluo/pull/3610) [`9aad8bd`](https://github.com/fluojs/fluo/commit/9aad8bd13b8b49264a3be1431cdc735a2f410a0c) Thanks [@ayden94](https://github.com/ayden94)! - Clarify the asymmetric Fastify raw request and response objects exposed through `RequestContext` and recommend portable framework APIs by default.

- [#3458](https://github.com/fluojs/fluo/pull/3458) [`16b1d36`](https://github.com/fluojs/fluo/commit/16b1d361e94fd771a4c7f28a41817ae20a326bdb) Thanks [@ayden94](https://github.com/ayden94)! - Parse only the normalized primary `Content-Type` media type when selecting multipart raw-body handling and JSON string response serialization. Treat `application/json` and structured `+json` suffixes as JSON-compatible so media-type parameters cannot misclassify requests or responses.

- [#3425](https://github.com/fluojs/fluo/pull/3425) [`6c7d587`](https://github.com/fluojs/fluo/commit/6c7d5874c583b5cd86719e9450e05f95bda56dfd) Thanks [@ayden94](https://github.com/ayden94)! - Run Fastify `onClose` cleanup when shutdown cancels startup, including after the final port bind completes, without masking the startup failure when cleanup also rejects. Startup rejection objects retain their identity and expose cleanup failures through `cause` only when that property can be read, written, and read back; every other rejection instead throws a startup-first `AggregateError` because identity preservation and cleanup reachability cannot both be guaranteed.

- [#3564](https://github.com/fluojs/fluo/pull/3564) [`af24ce9`](https://github.com/fluojs/fluo/commit/af24ce9c5410ea16550f9dca280d005817674c6a) Thanks [@ayden94](https://github.com/ayden94)! - Preserve the public static-response compression boundary: Express and Fastify leave the `@fluojs/http`-selected representation bytes intact instead of adapter-specific re-encoding when compression is enabled.

- [#3703](https://github.com/fluojs/fluo/pull/3703) [`b985cef`](https://github.com/fluojs/fluo/commit/b985cef3cbc68f3055981c86778939905db4054a) Thanks [@ayden94](https://github.com/ayden94)! - Require Fastify `^5.12.3`, including the upstream proxy-identity and root-primitive schema validation fixes, instead of allowing `5.8.5`. Existing Fluo routing, query parsing, proxy trust, and validation contracts remain unchanged.
