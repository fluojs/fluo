...
- [#3605](https://github.com/fluojs/fluo/pull/3605) [`a7d0aa1`](https://github.com/fluojs/fluo/commit/a7d0aa1a68bd066e525c773df345167ff2cf78bf) Thanks [@ayden94](https://github.com/ayden94)! - Add the optional request-scoped Early Hints capability to the Express 2.0.0 release. This backward-compatible adapter feature ships alongside the custom-route-methods and coordinated Node.js 24 migration.
...
- [#3013](https://github.com/fluojs/fluo/pull/3013) [`0a4573e`](https://github.com/fluojs/fluo/commit/0a4573e670a82bb460d21482a2b355c91a4573ee) Thanks [@ayden94](https://github.com/ayden94)! - Stop fluo dispatch when native Express middleware ends or destroys the response before calling `next()`.

- [`f7ea343`](https://github.com/fluojs/fluo/commit/f7ea343a2c33f12597364c098ea4250747b3e3ec) Thanks [@ayden94](https://github.com/ayden94)! - Refresh native route descriptors when an Express adapter is listened again after close so requests use the current application graph.
