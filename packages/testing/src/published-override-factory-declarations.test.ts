...
const consumerFixturePath = resolve(packageRootPath, 'src/override-factory-consumer.test-fixture.ts');

describe('@fluojs/testing published override factory declarations', () => {
  beforeAll(async () => {
  ...
  it('accepts typed injected factories against published declarations', () => {
    const program = ts.createProgram([consumerFixturePath], {
      ...
      noEmit: true,
      paths: {
        '@fluojs/testing': ['dist/index.d.ts'],
      },
      strict: true,
