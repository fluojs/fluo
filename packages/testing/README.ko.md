...
Generated ETag, bodyless conditional GET/HEAD 동작, unsafe precondition ordering을 adapter의 실제 listener 또는 fetch dispatch seam으로 증명하려면 `assertSupportsConditionalRequests()`를 사용하세요.
