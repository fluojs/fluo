...
`,
    ...
    expect(migratedSource).toContain("import { ExpressHttpApplicationAdapter } from \"@fluojs/platform-express\";");
    expect(migratedSource).toContain('adapter: ExpressHttpApplicationAdapter.create({');
