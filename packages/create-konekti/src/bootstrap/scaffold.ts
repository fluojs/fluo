...
function copyFrameworkSources(repoRoot: string, targetDirectory: string): void {
  const packageNames = ['core', 'config', 'di', 'module', 'http', 'jwt', 'passport'] as const;
...
function createAppPackageJson(projectName: string): string {
  return JSON.stringify(
    {
      dependencies: {
...
class LocalJwtStrategy implements AuthStrategy {
  static inject = [DefaultJwtVerifier];
...
Get('/profile')(HealthController.prototype, 'getProfile');
RequireScopes('profile:read')(
  HealthController.prototype,
  'getProfile',
  Object.getOwnPropertyDescriptor(HealthController.prototype, 'getProfile')!,
);
UseAuth('jwt')(
  HealthController.prototype,
  'getProfile',
...
function scaffoldAppPackage(targetDirectory: string, options: CreateKonektiOptions): void {
  ...
  writeTextFile(join(appDirectory, 'package.json'), createAppPackageJson(options.projectName));
...
export async function scaffoldKonektiApp(options: CreateKonektiOptions): Promise<void> {
  ...
  copyFrameworkSources(repoRoot, targetDirectory);
