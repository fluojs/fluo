...
- **핵심 런타임 타입**: `RequestContext`, `FrameworkRequest`, `FrameworkRequestFile`, `FrameworkResponse`, `ResponseFormatter`, `SseResponse`, `SseMessage`, `Middleware`, `MiddlewareContext`, `MiddlewareRouteConfig`, `Next`, `Guard`, `GuardContext`, `Interceptor`, `InterceptorContext`, `CallHandler`, `RequestObserver`, `DispatcherLogger`
