...
- **Static assets**: `createStaticAssetsMiddleware`, `StaticAssetSource`, `StaticAsset`, `StaticAssetResolution`, `StaticAssetsMiddleware`, `StaticAssetsMiddlewareOptions`
- **Response transport controls**: `FrameworkResponseSendOptions`, `FrameworkResponseStream` (`onError` returns an optional remover and reports every transport failure value)
