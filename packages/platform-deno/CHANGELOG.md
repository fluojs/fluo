...
- [#3420](https://github.com/fluojs/fluo/pull/3420) [`2ac124e`](https://github.com/fluojs/fluo/commit/2ac124e3913b834149bb8c101a60d3768b5046cd) Thanks [@ayden94](https://github.com/ayden94)! - `DenoWebSocketMessage` now includes the `ArrayBuffer` and `ArrayBufferView` binary
...
- [#3625](https://github.com/fluojs/fluo/pull/3625) [`ae19f27`](https://github.com/fluojs/fluo/commit/ae19f273a7fbd3b0de44f2877e7f69a3efa18c36) Thanks [@ayden94](https://github.com/ayden94)! - Add the public host-owned `createDenoFetchHandler(...)` entrypoint and verify the published Deno adapter journey under native Deno 2, including request dispatch and managed server shutdown.

### Patch Changes

- [#3430](https://github.com/fluojs/fluo/pull/3430) [`9b2a38e`](https://github.com/fluojs/fluo/commit/9b2a38e05139f1d1499093fa674c09e13bb9ef38) Thanks [@ayden94](https://github.com/ayden94)! - Clarify that hosts own failure-status propagation and termination for Deno signal-triggered close failures.
...
- [#3410](https://github.com/fluojs/fluo/pull/3410) [`5cc90a6`](https://github.com/fluojs/fluo/commit/5cc90a66e9abab5cc0f87b358bbfb8090ede759a) Thanks [@ayden94](https://github.com/ayden94)! - Release managed Deno adapter ownership after forced shutdown termination settles, even when graceful `server.shutdown()` remains pending.

- [#2836](https://github.com/fluojs/fluo/pull/2836) [`b03d472`](https://github.com/fluojs/fluo/commit/b03d4726d55d29166f92658a30ac2cd87c2bf35f) Thanks [@ayden94](https://github.com/ayden94)! - Restore the adapter's pre-listen state when `Deno.serve(...)` throws so requests remain gated and a later listen attempt can retry.

- [#3087](https://github.com/fluojs/fluo/pull/3087) [`724290a`](https://github.com/fluojs/fluo/commit/724290a971b24cccc54026aeac8800f7b8d32669) Thanks [@ayden94](https://github.com/ayden94)! - Retain the managed Deno server controller after graceful shutdown fails until server termination is confirmed, then rethrow the original shutdown error.
...
- f87a041: Document and verify Deno HTTPS startup portability by forwarding `https.cert` and `https.key` to `Deno.serve` and reporting HTTPS listen URLs.
